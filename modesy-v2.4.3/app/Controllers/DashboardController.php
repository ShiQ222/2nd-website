...
class DashboardController extends BaseController
{
    ...
    public function editProductDetails($id)
    {
        ...
        $data['brands'] = $this->commonModel->getBrands();
        $data['panelSettings'] = getPanelSettings();
    ...
    public function earnings()
    {
        ...
        $data['pager'] = paginate($this->perPage, $data['numRows']);
        $data['earnings'] = $this->earningsModel->getEarningsPaginated($this->userId, $this->perPage, $data['pager']->offset);
    ...
    public function payouts()
    {
        ...
        $data['pager'] = paginate($this->perPage, $data['numRows']);
        $data['payouts'] = $this->earningsModel->getPaginatedPayouts($this->userId, $this->perPage, $data['pager']->offset);
    ...
    public function paymentHistory()
    {
        ...
        if ($payment == 'membership') {
            ...
            $data['pager'] = paginate($this->perPage, $data['numRows']);
            $data['transactions'] = $this->membershipModel->getMembershipTransactionsPaginated($this->userId, $this->perPage, $data['pager']->offset);
            echo view('dashboard/includes/_header', $data);
    ...
    public function shopSettingsPost()
    {
        ...
        } elseif ($submit == 'cash_on_delivery') {
